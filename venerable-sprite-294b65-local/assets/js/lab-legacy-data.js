export const TRANSLATIONS = {
      ar: {
        ...
        unity: {
          ...
          loadingHtml: '<strong>Loading html:</strong> Interactive guidance for this step.',
          noteHtml: '<strong>Note html:</strong> Interactive guidance for this step.',
          stats: {
        ...
        biology: {
          ...
          readouts: {
            waterClear: 'Water clear',
            waterColored: 'Water colored',
            leafWhite: 'Leaf white',
            leafTinted: 'Leaf tinted'
          },
          explanationHtml: '<strong>Explanation html:</strong> Interactive guidance for this step.'
        },
        physics: {
          eyebrow: 'Eyebrow',
          title: 'Title',
          ...
          collision: {
            ...
            ready: 'Ready',
            launching: 'Launching',
            initialMomentum: 'Initial momentum',
            finalMomentum: 'Final momentum',
            velocities: 'Velocities'
          },
          controlsHtml: '<strong>Controls html:</strong> Interactive guidance for this step.',
          hintHtml: '<strong>Hint html:</strong> Interactive guidance for this step.',
          units: {
            meter: 'Meter',
            second: 'Second',
        ...
        chemistry: {
          ...
          readouts: {
            gasNone: 'Gas none',
            gasEvolving: 'Gas evolving',
            gasReady: 'Gas ready',
            flameWaiting: 'Flame waiting',
            flameSuccess: 'Flame success'
          },
          equationHtml: '<strong>Equation html:</strong> Interactive guidance for this step.'
        },
        common: {
          error: 'Error',
          dragDrop: 'Drag drop'
